...
def draw_word_cloud(word_cloud):
    ...
    '''
    font = r'D:\字体库\ppt粥字体库\PPT高手必备素材之2-专业设计149个中文字体（ppt粥）\！设计师必备中文字体更新中/华康少女体 .ttf'  # 这个太大，需要自己找下
...
def test_draw():
    ...
    model = models.Word2Vec.load(r"E:\Word2Vec-Wiki\WikiModel-MyModel\wiki_corpus.model")  # 这个zhwiki_news.word2vec是我训练好的，你可以直接Load你训练好的model
    # 输入一个词找出相似的前10个词
    one_corpus = ["心理"]
